...
const AIConfigForm = ({
  ...
  return (
    <div className="grid md:grid-cols-2 gap-8">
      {/* Left Column - Web Preview */}
      <div className="bg-white p-8 rounded-lg border-2 border-cohere-light-gray">
        <h3 className="text-xl font-bold text-cohere-dark-green mb-4">Web Preview</h3>
      ...
      <div className="bg-white p-8 rounded-lg border-2 border-cohere-light-gray space-y-6 max-h-[80vh] overflow-y-auto">
