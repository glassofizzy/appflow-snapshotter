...
const AIConfigForm = ({
  ...
  return (
    <div className="grid md:grid-cols-2 gap-8 w-full">
      {/* Left Column - Preview */}
      <div className="bg-white p-8 rounded-lg border-2 border-cohere-light-gray h-fit">
        <h3 className="text-xl font-bold text-cohere-dark-green mb-4">App/URL Preview</h3>
        <div className="aspect-video bg-cohere-light-gray rounded-lg flex items-center justify-center">
          {webUrl ? (
            <p className="text-cohere-medium-gray break-all px-4">{webUrl}</p>
          ) : (
      ...
      {/* Right Column - Form */}
      <div className="bg-white p-8 rounded-lg border-2 border-cohere-light-gray max-h-[80vh] overflow-y-auto">
